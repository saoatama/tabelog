...
class ReservesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserf" do
    assert_difference('Reserve.count') do
      post reserves_url, params: { reserf: { date: @reserf.date, e_mail: @reserf.e_mail, is_reserved: @reserf.is_reserved, is_smoke: @reserf.is_smoke, member: @reserf.member, name: @reserf.name, references: @reserf.references, time: @reserf.time } }
    end
  ...
  test "should update reserf" do
    patch reserf_url(@reserf), params: { reserf: { date: @reserf.date, e_mail: @reserf.e_mail, is_reserved: @reserf.is_reserved, is_smoke: @reserf.is_smoke, member: @reserf.member, name: @reserf.name, references: @reserf.references, time: @reserf.time } }
